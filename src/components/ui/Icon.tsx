...
const paths: Record<string, string[]> = {
  ...
  briefcase: ['M4 7h16a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1z', 'M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2', 'M3 12h18'],
  heart: ['M20.8 5.6a5.5 5.5 0 0 0-7.8 0L12 6.6l-1-1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8z'],
  alert: ['M12 9v4', 'M12 17h.01', 'M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z'],
  gauge: ['M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4z', 'm13.4 12.6 3.6-3.6', 'M4.5 18a9 9 0 1 1 15 0', 'M12 6v0'],
  building: ['M4 21V5a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v16', 'M15 9h4a1 1 0 0 1 1 1v11', 'M8 8h0', 'M8 12h0', 'M11 8h0', 'M11 12h0', 'M8 21v-4h3v4'],
  clipboard: ['M9 3h6a1 1 0 0 1 1 1v1H8V4a1 1 0 0 1 1-1z', 'M8 5H6a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-2', 'M9 11h6', 'M9 15h4'],
  wand: ['m15 4 1.5 1.5', 'M3 21 14 10l-1.5-1.5L1.5 19.5z', 'm14 10 1.5-4.5L20 4l-4.5-1.5L14 2l-1.5 4.5L8 8l4.5 1.5z', 'M20 14l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7z'],
  send: ['M22 2 11 13', 'M22 2 15 22l-4-9-9-4z'],
  compass: ['M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z', 'm16.2 7.8-2.9 6.4-6.4 2.9 2.9-6.4z'],
};
