      ...
      <Card>
        ...
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={series} margin={{ left: -18, right: 8, top: 4, bottom: 0 }}>
            ...
            <Line type="monotone" dataKey="Actual" stroke="#123A7B" strokeWidth={2.5} dot={false} />
            <Line type="monotone" dataKey="Projected" stroke="#F4C20C" strokeWidth={2.5} strokeDasharray="5 4" dot={false} />
